...
//       inventoryItemId: 'gid://shopify/InventoryItem/48986053214431',
//       locationId: 'gid://shopify/Location/81945329887',
//     }]));
...
export async function POST(req: Request) {
  try {
    ...
    const itemMap = new Map(items.map(item => [item.id, {
      inventoryItemId: 'gid://shopify/InventoryItem/48986176848095', // Dynamic value from DB
      locationId: 'gid://shopify/Location/81945329887',           // Dynamic value from DB
    }]));
